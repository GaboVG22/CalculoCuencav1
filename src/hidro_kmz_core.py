...
DGA_AC_PRESETS = {
    ...
    "Zona Jp pluvial Limarí (editable)": {"mode": "iii_iv_formula", "coef": 1.94e-7, "area_exp": 0.776, "p_exp": 3.108, "factors": {2: 0.24, 5: 0.61, 10: 1.00, 25: 1.71, 50: 2.41, 100: 3.30, 200: 4.19}, "alpha_inst": 1.25, "nota": "Preset de trabajo, confirmar en tabla DGA oficial. Factor 200 años referencial/extrapolado; editable."},
